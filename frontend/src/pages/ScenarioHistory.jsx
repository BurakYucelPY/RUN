...
const items = [
  {
    id: 'tarih_titanik',
    image: getAssetPath('/assets/categoriesHistory/BatanGemiTitanik.png'),
  ...
  {
    id: 'tarih_piramit',
    image: getAssetPath('/assets/categoriesHistory/FiravununLaneti.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'tarih_gladyator',
    image: getAssetPath('/assets/categoriesHistory/GladyatorArenasi.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'tarih_savas',
    image: getAssetPath('/assets/categoriesHistory/SiperSavaşi1917.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'tarih_kovboy',
    image: getAssetPath('/assets/categoriesHistory/VahsiBatiSoygunu.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'tarih_viking',
    image: getAssetPath('/assets/categoriesHistory/VikingBaskini.png'),
    link: 'https://google.com/',
