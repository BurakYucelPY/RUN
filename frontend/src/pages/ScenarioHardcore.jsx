...
const items = [
  {
    id: 'hard_kor',
    image: getAssetPath('/assets/categoriesHardcore/KorveSagir.png'),
  ...
  {
    id: 'hard_nukleer',
    image: getAssetPath('/assets/categoriesHardcore/NukleerSiginak.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'hard_parasut',
    image: getAssetPath('/assets/categoriesHardcore/ParasutsuzDusus.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'hard_okyanus',
    image: getAssetPath('/assets/categoriesHardcore/OkyanusunOrtasi.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'hard_magara',
    image: getAssetPath('/assets/categoriesHardcore/SuDoluMagara.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'hard_cig',
    image: getAssetPath('/assets/categoriesHardcore/ÇigAltinda.png'),
    link: 'https://google.com/',
    title: 'Çığ Altında',
