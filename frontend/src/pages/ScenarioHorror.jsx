...
const items = [
  {
    id: 'korku_diri',
    image: getAssetPath('/assets/categoriesHorror/DiriDiriGomulen.png'),
  ...
  {
    id: 'korku_akil',
    image: getAssetPath('/assets/categoriesHorror/AkılHastanesiBlokC.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'korku_metro',
    image: getAssetPath('/assets/categoriesHorror/GeceYarisiMetro.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'korku_bodrum',
    image: getAssetPath('/assets/categoriesHorror/SeriKatilinBodrumu.png'),
    link: 'https://google.com/',
  ...
  {
    id: 'korku_bebek',
    image: getAssetPath('/assets/categoriesHorror/LanetliBebek.png'),
    link: 'https://google.com/',
    title: 'Lanetli Bebek',
  ...
  {
    id: 'korku_otel',
    image: getAssetPath('/assets/categoriesHorror/OtelOdasi303.png'),
    link: 'https://google.com/',
